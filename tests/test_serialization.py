...
def test_solvability_classifier_serialization_deserialization(solvability_classifier):
    ...
    assert deserialized.importance_strategy == solvability_classifier.importance_strategy
    assert deserialized.classifier.get_params() == solvability_classifier.classifier.get_params()
...
def test_fitted_rfc_serialization_deserialization(mock_classifier):
    ...
    np.testing.assert_array_almost_equal(deserialized.feature_importances_, mock_classifier.feature_importances_)
